...
(custom-set-variables
 ...
 '(gnutls-algorithm-priority "normal:-vers-tls1.3")
  '(package-selected-packages
     '(apache-mode gitignore-mode prettier eglot json-mode all-the-icons ace-jump-mode whitespace-cleanup-mode vscdark-theme vs-dark-theme sunny-day-theme silkworm-theme treemacs writeroom-mode vue-mode git-timemachine move-text restart-emacs web-mode rainbow-delimiters flycheck-popup-tip smartparens helm-swoop company spaceline apropospriate-theme ample-theme diff-hl markdown-mode tide helm-ag helm xah-elisp-mode xwwp-follow-link-helm spacemacs-theme drag-stuff aggressive-indent shell-pop yaml-mode melancholy-theme exec-path-from-shell add-node-modules-path js2-mode flycheck powerline use-package projectile neotree magit))
