...
Marks or unmarks the absolute path of the node at point." t nil)

(autoload 'treemacs-reset-marks "treemacs-file-management" "\
Removes all previously made marks in the current buffer." t nil)

(autoload 'treemacs-delete-marked-paths "treemacs-file-management" nil t nil)
...
files with `treemacs-show-marked-files' or `s' in the hydra." t nil)
